			...
			<div className="mx-auto grid min-h-screen max-w-7xl grid-cols-1 lg:grid-cols-2">
				...
				<div className="hidden lg:flex flex-col justify-between p-10 bg-white/60 backdrop-blur border-r border-slate-200">
					<div className="flex items-center gap-3">
						...
						<span className="text-xl font-semibold text-slate-900">DigiAccel</span>
					</div>
					...
					<div className="flex-1 flex items-center">
						<div className="max-w-md">
							...
							<ul className="mt-6 space-y-3 text-slate-700">
								<li className="flex items-center gap-2"><span className="h-1.5 w-1.5 rounded-full bg-indigo-600"/> Smart onboarding</li>
								<li className="flex items-center gap-2"><span className="h-1.5 w-1.5 rounded-full bg-indigo-600"/> Privacy-first design</li>
								<li className="flex items-center gap-2"><span className="h-1.5 w-1.5 rounded-full bg-indigo-600"/> Fast support</li>
							</ul>
						</div>
					</div>

					<p className="text-xs text-slate-500">© {new Date().getFullYear()} DigiAccel</p>
				</div>
						...
						<div className="mb-4">
							...
							>
								<svg
									...
									className="h-5 w-5"
								>
									<path fill="#FFC107" d="M43.6 20.5H42V20H24v8h11.3C33.7 31.4 29.3 34 24 34c-7 0-12.9-5.8-12.9-13S17 8 24 8c3.3 0 6.3 1.2 8.6 3.3l5.7-5.7C34.7 2.7 29.6 1 24 1 11.8 1 2 10.8 2 23s9.8 22 22 22c11 0 21-8 21-22 0-1.3-.1-2.2-.4-3.5z" />
									<path fill="#FF3D00" d="M6.3 14.7l6.6 4.8C14.7 16.4 18.9 14 24 14c3.3 0 6.3 1.2 8.6 3.3l5.7-5.7C34.7 2.7 29.6 1 24 1 15 1 7.1 6.1 3.7 13.4l2.6 1.3z" />
									<path fill="#4CAF50" d="M24 45c5.2 0 10-1.7 13.8-4.7l-6.4-5.2C29 36.3 26.6 37 24 37c-5.3 0-9.7-3.6-11.4-8.5l-6.5 5C7 40.6 14.9 45 24 45z" />
									<path fill="#1976D2" d="M43.6 20.5H42V20H24v8h11.3c-1.2 3.4-4.4 6-8.3 6-5.3 0-9.7-3.6-11.4-8.5l-6.5 5C11 40.6 18.9 45 24 45c11 0 21-8 21-22 0-1.3-.1-2.2-.4-3.5z" />
								</svg>
								Sign up with Google
							</button>
						</div>
						...
						<form onSubmit={onSubmit} noValidate className="space-y-4">
							...
							<div className="flex items-start gap-3">
								...
								<label htmlFor="terms" className="text-sm text-slate-700">
									I agree to the <a className="text-indigo-600 hover:text-indigo-700" href="#">Terms</a> and <a className="text-indigo-600 hover:text-indigo-700" href="#">Privacy Policy</a>
								</label>
							</div>
							{errors.terms && (
